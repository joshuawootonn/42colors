...
function getLogDescription(log: Log, selectPlot: (id: number) => void): ReactNode {
  switch (log.logType) {
    case "initial_grant":
      ...
      <PopoverContent className="w-80" positionerProps={positionerProps}>
        ...
        <div className="flex h-80 overflow-auto">
          {isLoading ? (
            ...
            <div className="flex-1 pt-20 text-center text-sm text-red-600">Failed to load logs</div>
            ...
            <div className="flex w-full flex-col">
              {logs.map((log) => {
                const balanceChange = getBalanceChangeDisplay(log.oldBalance, log.newBalance);
                const isSelected = selectedPlotId === log.plotId;
