...
const PopoverContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Popup> & {
    positionerProps?: React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Positioner>;
    isDraggable?: boolean;
...
export { Popover, PopoverTrigger, PopoverContent, PopoverArrow, PopoverHeading };
