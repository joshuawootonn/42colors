      ...
      try {
        ...
        const polygonBuffers = polygonData.map((polygon) => {
          ...
          for (let i = 1; i < numVertices - 1; i++) {
            ...
            vertices.push(polygon.vertices[i * 2], polygon.vertices[i * 2 + 1])
            vertices.push(polygon.vertices[(i + 1) * 2], polygon.vertices[(i + 1) * 2 + 1])
          }
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white">
        <div className="text-center">
          ...
          <p className="text-lg mb-4">
            Your browser does not support WebGPU. Please use Chrome with WebGPU enabled.
          </p>
        </div>
      </div>
    )
