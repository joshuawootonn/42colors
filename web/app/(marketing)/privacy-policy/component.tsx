...
export function PrivacyPolicy() {
  return (
    <>
      ...
      <p>
        I (Josh Wootonn) have no intention of ever sharing or selling the data collected. If the
        usage of 42colors starts to outpace the free tiers of the products I am using, then my
        monetization strategy will be donation based.
      </p>

      <H2>contact</H2>
      <p>
        <EmailLink className="svg-outline-sm underline">Contact me</EmailLink> if you have any
        questions about 42colors&apos; privacy policy, the data it holds on you, or you would like
        to exercise one of your data protection rights.
      </p>
