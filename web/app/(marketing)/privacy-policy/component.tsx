        ...
        <>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>
                        Send occasional update emails - no more than 6 a year
                    </li>
                </ul>
            </div>
            <H2>how does 42colors store your data?</H2>
            <p>
                42colors securely stores your data in a digital ocean database.
            </p>
            <H2>Does 42colors share data</H2>
            <p>
                I (Josh Wootonn) have no intention of ever sharing or selling
                the data collected. If the usage of 42colors starts to outpace
                the free tiers of the products I am using, then my monetization
                strategy will be donation based.
            </p>
            ...
            <p>
                ...
                if you have any questions about 42colors&apos; privacy policy,
                the data it holds on you, or you would like to exercise one of
