...
function ColorBlock({ variable }: { variable: string }) {
  return (
    <div
      className={cn(`relative aspect-square w-30 border-1.5 border-primary`)}
      style={{
        backgroundColor: `hsl(var(${variable}))`,
      }}
    >
      <code className="absolute left-0 top-0 bg-primary text-xs text-secondary">{variable}</code>
    </div>
  );
}
  ...
  return (
    <div className="prose mx-10 my-20 max-w-full">
      ...
      <p className="text-sm text-muted-foreground">
        All toast messages in the application. These are the only allowed toast configurations.
      </p>
      <div className="not-prose flex w-full flex-col gap-4">
        ...
        <div className="space-y-2">
          <h3 className="text-sm font-medium">Login to Save Pixels</h3>
          <Toast
        ...
        <div className="space-y-2">
          <h3 className="text-sm font-medium">Cannot Bucket Fill Other Plot</h3>
          <Toast
        ...
        <div className="space-y-2">
          <h3 className="text-sm font-medium">Cannot Bucket Fill Outside Plot</h3>
          <Toast
        ...
        <div className="space-y-2">
          <h3 className="text-sm font-medium">Login to Use Eyedropper</h3>
          <Toast
